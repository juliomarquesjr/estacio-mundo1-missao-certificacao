...
class GraficoFerramenta:
    def __init__(self, codigo_ferramenta=False):
        ...
        self.lb_ref = Label(self.principal, text="Referência: ")
        ...
        ## Caixas de texto.
        self.cx_codigo = Entry(self.principal, width=20)
        self.cx_tamanho = Entry(self.principal, width=25)
        self.cx_volts = Entry(self.principal, width=20)
        self.cx_und = Entry(self.principal, width=20)
        self.cx_tipo = Entry(self.principal, width=20)
        self.cx_mat = Entry(self.principal, width=20)
        self.cx_ref = Entry(self.principal, width=30)
        self.cx_temp = Entry(self.principal, width=15)
        self.cx_fab = Entry(self.principal, width=35)
        self.cx_desc = Entry(self.principal, width=65)
        ...
        self.lb_tipo.place(x=10, y=10)
        self.cx_tipo.place(x=47, y=10)
        self.lb_tamanho.place(x=250, y=10)
        self.cx_tamanho.place(x=315, y=10)
        self.lb_codigo.place(x=10, y=40)
        self.cx_codigo.place(x=65, y=40)
        self.lb_und.place(x=285, y=40)
        self.cx_und.place(x=345, y=40)
        self.lb_volts.place(x=10, y=70)
        self.cx_volts.place(x=75, y=70)
        self.lb_mat.place(x=287, y=70)
        self.cx_mat.place(x=345, y=70)
        self.lb_ref.place(x=10, y=100)
        self.cx_ref.place(x=80, y=100)
        self.lb_temp.place(x=290, y=100)
        self.cx_temp.place(x=375, y=100)
        self.lb_fab.place(x=10, y=130)
        self.cx_fab.place(x=80, y=130)
        self.lb_desc.place(x=10, y=160)
        self.cx_desc.place(x=75, y=160)
